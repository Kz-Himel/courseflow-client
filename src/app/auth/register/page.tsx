          ...
          <div className="flex w-full items-center justify-center bg-white px-4 py-12 sm:px-8 lg:w-1/2">
            <div className="w-full max-w-sm">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full rounded-lg border py-2.5 pl-9 pr-3 text-sm text-gray-900 font-medium placeholder:text-gray-400 placeholder:font-normal outline-none transition-colors focus:border-[#6C5CE7] ${
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full rounded-lg border py-2.5 pl-9 pr-9 text-sm text-gray-900 font-medium placeholder:text-gray-400 placeholder:font-normal outline-none transition-colors focus:border-[#6C5CE7] ${
              ...
              <button
                ...
                disabled={isSubmitting || isGoogleSubmitting}
                className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-gray-200 bg-white py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50 active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60"
              >
                <FcGoogle size={18} />
