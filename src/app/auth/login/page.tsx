        ...
        <div className="flex w-full min-h-[calc(100vh-160px)] overflow-hidden rounded-2xl border border-gray-100 shadow-md">
          ...
          <div className="flex w-full items-center justify-center bg-white px-4 py-12 sm:px-8 lg:w-1/2">
            <div className="w-full max-w-sm">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full rounded-lg border bg-white py-2.5 pl-9 pr-3 text-sm text-gray-900 font-medium placeholder:text-gray-400 placeholder:font-normal outline-none transition-colors focus:border-[#6C5CE7] focus:ring-1 focus:ring-[#6C5CE7] ${
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full rounded-lg border bg-white py-2.5 pl-9 pr-9 text-sm text-gray-900 font-medium placeholder:text-gray-400 placeholder:font-normal outline-none transition-colors focus:border-[#6C5CE7] focus:ring-1 focus:ring-[#6C5CE7] ${
              ...
              {/* গুগল ও ডেমো লগইন বাটন (নিচে নিয়ে আসা হয়েছে) */}
